...
//       const footerHeight = windowHeight * 0.8;
      
//       const triggerPoint = documentHeight - windowHeight - footerHeight;
      
//       if (scrollY >= triggerPoint) {
//         const progress = Math.min(scrollY - triggerPoint, footerHeight);
//         mainElement.style.transform = `translateY(-${progress}px)`;
//       } else {
