...
function NavigationPhone({ t, getRoute, changeLanguage, language, availableLanguages, onClose, isClosing }) {
    const location = useLocation();
    ...
    return (
        <div className={`navigation-phone-overlay ${isClosing ? 'closing' : ''}`}>
            <div className="navigation-phone-content">
                <Link to={getRoute('home')} onClick={onClose}>
                    <div className="navigation-phone-logo">
