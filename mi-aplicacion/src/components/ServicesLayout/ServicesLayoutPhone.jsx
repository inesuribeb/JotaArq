...
function ServicesLayoutPhone({ bgImage, title, subtitle, text, dark, t }) {
    ...
    // Determinar si bgImage es array o string
    ...
    useEffect(() => {
        ...
        const autoScroll = () => {
            if (!isPausedRef.current && carousel) {
                ...
                // Reset cuando llega a la mitad (loop infinito)
    ...
    const handleTouchStart = (e) => {
        ...
        // Pausar auto-scroll inmediatamente
    ...
    const handleTouchMove = (e) => {
        ...
        const walk = startX - x; // Distancia movida
