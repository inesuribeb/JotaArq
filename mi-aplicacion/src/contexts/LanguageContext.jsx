...
// ============================================
// NUEVO: Mapeo de páginas a endpoints de Strapi
// ============================================
const pageToEndpoint = {
  home: 'pages',
...
export const LanguageProvider = ({ children }) => {
  ...
  // ============================================
  // NUEVO: Estados para contenido dinámico de Strapi
  // ============================================
  ...
  // ============================================
  // NUEVO: Función para cargar contenido de Strapi
  // ============================================
  ...
  // ============================================
  // MODIFICADO: Función t() con soporte para Strapi
  // ============================================
  const t = (key, page = null) => {
    // Si especificas una página, intenta buscar primero en Strapi
  ...
  return (
    <LanguageContext.Provider value={{
      ...
      routes,
      availableLanguages: ['es', 'eu', 'en'],
      // NUEVO: Exportar funciones y estados de Strapi
      loadPageContent,
      loading,
      error
    }}>
